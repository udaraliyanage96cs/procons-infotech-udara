                        ...
                        <div class="card-body">
                            ...
                            <div class="app-brand justify-content-center">
                                <a href="index.html" class="app-brand-link gap-2">
                                    ...
                                    <span class="app-brand-text demo h3 mb-0 fw-bold">UPOS</span>
                                </a>
                            </div>
                            <!-- /Logo -->
                            ...
                            @if ($errors->any())
                                @if (implode('', $errors->all(':message')) == 'success')
                                    <div class="alert alert-success alert-dismissible mb-4" id="success-alert"
                                        role="alert">
                                        <ul class="list-unstyled mb-0">
                                            <li>Your have successfully updated your password. Try to login <a
                                                    href="/">Here</a>!</li>
                                        </ul>
                                    </div>
                                @elseif(implode('', $errors->all(':message')) == 'faild')
                                    <div class="alert alert-danger alert-dismissible mb-4" id="success-alert"
                                        role="alert">
                                        <ul class="list-unstyled mb-0">
                                            <li>Sorry, Your token not matched!</li>
                                        </ul>
                                    </div>
                                @elseif(implode('', $errors->all(':message')) == 'expired')
                                    <div class="alert alert-danger alert-dismissible mb-4" id="success-alert"
                                        role="alert">
                                        <ul class="list-unstyled mb-0">
                                            <li>Sorry, Your token expired. Try again!</li>
                                        </ul>
                                    </div>
                                @endif
                            @else
                                <form class="mb-3 fv-plugins-bootstrap5 fv-plugins-framework"
                                    action="/reset_password/{{ $user_id }}" method="POST">
                                    {{ csrf_field() }}
