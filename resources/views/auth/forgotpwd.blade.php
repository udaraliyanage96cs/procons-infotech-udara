                        ...
                        @if ($errors->any())
                            @if (implode('', $errors->all(':message')) == 'success')
                                <div class="alert alert-success alert-dismissible mb-4" id="success-alert"
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        <li>Your password reset email has been successfully sent. Please check your
                                            mailbox!</li>
                                    </ul>
                                </div>
                            @elseif(implode('', $errors->all(':message')) == 'faild')
                                <div class="alert alert-danger alert-dismissible mb-4" id="success-alert"
                                    role="alert">
                                    <ul class="list-unstyled mb-0">
                                        <li>Sorry, Your email has not registed in the system!</li>
                                    </ul>
                                </div>
                            @endif
                        @else
                            <form class="mb-3 fv-plugins-bootstrap5 fv-plugins-framework" action="/forgot_password"
                                method="POST">
                                {{ csrf_field() }}
