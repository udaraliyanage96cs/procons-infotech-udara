...
<div class="card">
    <div class="card-header">
            ...
            <tbody class="table-border-bottom-0">
                @if (count($reports) > 0)
                    @foreach ($reports as $report)
                        <tr role="row" class="trow">
                            ...
                            <td class="text-right text-nowrap  justify-content-end pr-0">
                                <button type="submit" value="73" class="btn btn-icon btn-info mr-1 mb-1"
                                    name="SubOwner_delete" data-bs-toggle="modal" data-toggle="tooltip" data-placement="top" title="View Report"
                                    data-bs-target="#pricingModal-{{ $report->id }}"><i class="bx bx-show"></i>
                                </button>
                                @if (Auth::User()->role == 'admin')
                                    <a class="btn btn-icon @if ($report->status == '0') btn-success @else btn-danger @endif glow mr-1 mb-1" data-toggle="tooltip" data-placement="top" title="Approve Report"
                                ...
                                @endif
                                @if (Auth::User()->role != 'admin')
                                    <a class="btn btn-icon btn-success glow mr-1 mb-1" data-toggle="tooltip" data-placement="top" title="Edit Report"
                                        href="/dashboard/reports/edit/{{ $report->id }}"><i
                                            class='bx bx-edit-alt'></i></a>
                                    <button type="submit" value="73" class="btn btn-icon btn-danger mr-1 mb-1" data-toggle="tooltip" data-placement="top" title="Delete Report"
                        ...
                        @endif
                        <div class="modal fade" id="pricingModal-{{ $report->id }}"tabindex="-1" aria-labelledby="markerModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg modal-dialog-centered ">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <p><strong>Plant Name:</strong> <span id="modalPlantName">{{ $report->plant_name }}</span></p>
                                        <p><strong>Description:</strong> <span id="modalDescription">{{ $report->description }}</span></p>
                                    </div>
        ...
        <div id="reports-container">
            <!-- Filtered reports will be appended here -->
        </div>
